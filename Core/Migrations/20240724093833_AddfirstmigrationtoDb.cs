        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasLaptop = table.Column<int>(type: "int", nullable: false),
                    HasAnyProgrammingExp = table.Column<int>(type: "int", nullable: false),
                    ProgrammingLanguagesExps = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ApplicantResideInEnugu = table.Column<int>(type: "int", nullable: false),
                    ReasonForProgramming = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HowDoYouIntendToCopeStatement = table.Column<string>(type: "nvarchar(max)", nullable: false),
